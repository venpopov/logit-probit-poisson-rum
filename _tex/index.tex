...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, colframe=quarto-callout-note-color-frame, left=2mm, bottomrule=.15mm, coltitle=black, arc=.35mm, colback=white, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, title={Result 1 (Log-Gamma Random Utility Family)}, breakable, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, colframe=quarto-callout-note-color-frame, left=2mm, bottomrule=.15mm, coltitle=black, arc=.35mm, colback=white, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, title={Result 2 (Logit Boundary)}, breakable, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, colframe=quarto-callout-note-color-frame, left=2mm, bottomrule=.15mm, coltitle=black, arc=.35mm, colback=white, leftrule=.75mm, bottomtitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, title={Result 3 (Probit Limit)}, breakable, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6]
