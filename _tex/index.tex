...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, opacityback=0, leftrule=.75mm, bottomtitle=1mm, breakable, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, bottomrule=.15mm, left=2mm, title={Result 1 (Log-Gamma Random Utility Family)}, arc=.35mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, opacityback=0, leftrule=.75mm, bottomtitle=1mm, breakable, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, bottomrule=.15mm, left=2mm, title={Result 2 (Logit Boundary)}, arc=.35mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, titlerule=0mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, opacityback=0, leftrule=.75mm, bottomtitle=1mm, breakable, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, bottomrule=.15mm, left=2mm, title={Result 3 (Probit Limit)}, arc=.35mm, coltitle=black]
