...
\begin{tcolorbox}[enhanced jigsaw, title={Result 1 (Log-Gamma Random Utility Family)}, leftrule=.75mm, toprule=.15mm, arc=.35mm, left=2mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, opacityback=0, breakable, opacitybacktitle=0.6, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, titlerule=0mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Result 2 (Logit Boundary)}, leftrule=.75mm, toprule=.15mm, arc=.35mm, left=2mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, opacityback=0, breakable, opacitybacktitle=0.6, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, titlerule=0mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Result 3 (Probit Limit)}, leftrule=.75mm, toprule=.15mm, arc=.35mm, left=2mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, opacityback=0, breakable, opacitybacktitle=0.6, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, coltitle=black, titlerule=0mm, rightrule=.15mm]
