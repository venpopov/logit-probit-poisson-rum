...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-rum-overview-1.pdf}}
...
rather than dynamical: the standardization that enables comparison
...
(see Section~\ref{sec-variance-normalization} for details).
...
Race}\label{sec-generative-model}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, leftrule=.75mm, opacitybacktitle=0.6, colback=white, arc=.35mm, left=2mm, opacityback=0, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, bottomrule=.15mm, title={Result 1 (Log-Gamma Random Utility Family)}, toprule=.15mm]
...
(\(\theta = 1\))}{The Logit Boundary (\textbackslash theta = 1)}}\label{sec-logit-boundary}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, leftrule=.75mm, opacitybacktitle=0.6, colback=white, arc=.35mm, left=2mm, opacityback=0, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, bottomrule=.15mm, title={Result 2 (Logit Boundary)}, toprule=.15mm]
...
\section{Variance normalization}\label{sec-variance-normalization}
...
(\(\theta \to \infty\))}{The Probit Limit (\textbackslash theta \textbackslash to \textbackslash infty)}}\label{sec-probit-limit}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, leftrule=.75mm, opacitybacktitle=0.6, colback=white, arc=.35mm, left=2mm, opacityback=0, toptitle=1mm, rightrule=.15mm, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, bottomrule=.15mm, title={Result 3 (Probit Limit)}, toprule=.15mm]
...
Choice}\label{sec-binary-simulations}
...
adopted the variance standardization introduced in
Section~\ref{sec-variance-normalization}. For binary choice, the
variance of the utility noise difference is
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-residuals-1.pdf}}
...
Choice}\label{sec-multinomial-simulations}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-tv-distance-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-prob-vectors-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-set-size-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-iia-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-parameter-recovery-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-noise-densities-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-skew-kurtosis-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-robustness-1.pdf}}
...
Errors}\label{sec-correlated-errors}
...
When we apply the variance normalization from
Section~\ref{sec-variance-normalization} to enforce matched
discriminability, we define the standardized noise
...
normalization introduced in Section~\ref{sec-variance-normalization}
reveals critical boundary conditions of evidence accumulation.
...
discussed in Section~\ref{sec-variance-normalization}, this bridge is
distributional rather than dynamical: the variance standardization
compares different accumulation systems at matched discriminability,
rather than describing the behavior of a single system under threshold
manipulation. The goal is not to advocate replacing existing models, but
to clarify their relationship: logit and probit represent different
positions within a continuum of log-Gamma noise shapes, with the
accumulation threshold governing the transition between them.
