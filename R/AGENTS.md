...
This is a Quarto manuscript project. The main report is in index.qmd and all relevant artifacts in _manuscript are automatically generated from it.
...
quarto render                    # Render full website to _manuscript
```
